...
module Instructeurs
  class ProceduresController < InstructeurController
    ...
    def index
      ...
      @notifications_counts_per_procedure = nil # DossierNotification.notifications_counts_for_instructeur_procedures(groupe_ids, current_instructeur)
